...
resource_id = ""
inputFolderLocation = ""
processingFolderLocation = ""
processedFolderLocation = ""
...
class Producer:
    ...
    def copyToProcessingFolder(self):
        global inputFolderLocation, processingFolderLocation, processedFolderLocation
        src = inputFolderLocation #"InputFolder/"
        dst = processingFolderLocation #"ProcessingFolder/"
    ...
    def Processing(self):
        try:
            global conn, swarm_id,inputFolderLocation, processingFolderLocation, processedFolderLocation
            #respo = conn.getresponse()
            #print respo.status
            src = processingFolderLocation #"ProcessingFolder/"
            src_files = os.listdir(src)
    ...
    def copyToProcessedFolder(self):
        ...
        import shutil,os
        src = processingFolderLocation  #"ProcessingFolder/"
        dst = processedFolderLocation #"ProcessedFolder/"
        src_files = os.listdir(src)
        for file_name in src_files:
            if "_P" in file_name:
                print "in if"
